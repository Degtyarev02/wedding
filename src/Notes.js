...
const Notes = () => {
	...
	const notes = [
		...
		"Ужин в ресторане после росписи будет в кругу семьи.",
		"Друзья и подружки, нам будет проще собраться с вами в другой день в неформальной обстановке и провести время без суеты и спешки, больше информации мы сообщим Вам ближе к дате свадьбы",
		<>
