...
const Notes = () => {
	...
	const notes = [
		...
		"Ужин в ресторане после росписи будет в кругу семьи. Друзья и подружки, нам будет проще собраться с вами в индивидуальном порядке и провести время без суеты и спешки",
		<>
